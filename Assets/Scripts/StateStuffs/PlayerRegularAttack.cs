...
namespace Jeffu_Fighter
{
    ...
    public class PlayerRegularAttack : CharacterStateBase
    {
        ...
        {
            if (animator.GetCurrentAnimatorStateInfo(0).IsName("RegularAttack") && animator.GetCurrentAnimatorStateInfo(0).normalizedTime >= 0.4f)  //make sure the name here is correct!!! and number!!!
            {
